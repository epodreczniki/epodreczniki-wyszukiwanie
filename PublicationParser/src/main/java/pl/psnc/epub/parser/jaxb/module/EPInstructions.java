...
import pl.psnc.epub.solr.beans.context.EPInstructionsIndexItem;
 ...
 * @author spychala
 */
@XmlRootElement(name="instructions", namespace="http://epodreczniki.pl/")
public class EPInstructions  extends EPGenericElement {
    
    @Override
    public IndexItem generateSelfIndex(IndexItem parent, IndexContext context) {
        if (id != null && !"".equals(id)) {
            itemIndex = new EPInstructionsIndexItem(context);
