...
import pl.psnc.epub.solr.beans.context.EPCommandIndexItem;
 ...
 * @author spychala
 */
@XmlRootElement(name="command", namespace="http://epodreczniki.pl/")
public class EPCommand extends EPGenericElement {
    
    @Override
    public IndexItem generateSelfIndex(IndexItem parent, IndexContext context) {
        if (id != null && !"".equals(id)) {
            itemIndex = new EPCommandIndexItem(context);
