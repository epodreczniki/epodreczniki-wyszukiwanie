 ...
 * @author spychala
 */
@XmlRootElement(name="birth", namespace="http://epodreczniki.pl/")
public class EPBirth extends ModuleElement {
    ...
    @XmlElement(name="location", namespace="http://epodreczniki.pl/")
