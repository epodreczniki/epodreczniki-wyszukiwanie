...
import pl.psnc.epub.solr.beans.context.EPConceptIndexItem;
 ...
 * @author spychala
 */
@XmlRootElement(name="concept", namespace="http://epodreczniki.pl/")
public class EPConcept extends ModuleEntity {
    ...
    public IndexItem generateSelfIndex(IndexItem parent, IndexContext context) {
        ...
        if (id != null && !"".equals(id)) {
            itemIndex = new EPConceptIndexItem(context);
