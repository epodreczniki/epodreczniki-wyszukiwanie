...
import pl.psnc.epub.solr.beans.context.EPInstrumentsIndexItem;
 ...
 * @author spychala
 */
@XmlRootElement(name="instruments", namespace="http://epodreczniki.pl/")
public class EPInstruments  extends EPGenericElement {
    
    @Override
    public IndexItem generateSelfIndex(IndexItem parent, IndexContext context) {
        if (id != null && !"".equals(id)) {
            itemIndex = new EPInstrumentsIndexItem(context);
