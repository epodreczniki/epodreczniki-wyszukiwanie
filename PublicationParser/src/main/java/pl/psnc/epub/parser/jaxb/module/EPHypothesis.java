...
import pl.psnc.epub.solr.beans.context.EPHypothesisIndexItem;
 ...
 * @author spychala
 */
@XmlRootElement(name="hypothesis", namespace="http://epodreczniki.pl/")
public class EPHypothesis  extends EPGenericElement {
    
    @Override
    public IndexItem generateSelfIndex(IndexItem parent, IndexContext context) {
        if (id != null && !"".equals(id)) {
            itemIndex = new EPHypothesisIndexItem(context);
